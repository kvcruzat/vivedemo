...
\subsubsection{New Connection Matrix}
...
\subsubsection{Removing Edges From Graph}
...
\begin{figure}[H]
	\includegraphics[width=5cm]{triangulation1}
	\centering
...
\begin{figure}[H]
	\includegraphics[width=5cm]{triangulation2}
	\centering
...
\begin{figure}[H]
	\includegraphics[width=5cm]{triangulation3}
	\centering
...
\begin{figure}[H]
	\includegraphics[width=5cm]{triangulation4}
	\centering
...
\begin{figure}[H]
	\includegraphics[width=5cm]{triangulation5}
	\centering
...
\begin{figure}[H]
	\includegraphics[width=5cm]{triangulation6}
	\centering
...
\begin{figure}[H]
	\includegraphics[width=12cm]{finalTerrain}
	\centering
...
\begin{figure}[h]
	\includegraphics[width=5cm]{rodcollision}
	\centering
...
\begin{figure}[h]
	\includegraphics[width=10cm]{flowerstates}
	\centering
